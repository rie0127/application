...
<html lang="ja">
  ...
  <body>
   ...
   <form method='POST' action="{{ route('store.watched') }}">
    @csrf
  　
 ...
 　 
    <div class="mb-3 pb-2">
    <label>カテゴリー</label>    
　   <select class="form-select" aria-label="Default select example" name="anime[category_id]" >
 ...
 　<div class="mb-3 pb2">
    <label>評価</label>
   　 <select class="form-select" aria-label="Default select example" name="anime[evaluation]">
   　　<option selected value="">選択してください。</option>
...
　<div class="mb-3 pb-2">
    ...
    <textarea class="form-control" id="exampleFormControlTextarea1" name="anime[feeling]" value="{{ old('anime.feeling') }}" rows="3"></textarea>
